...
| `crypto/bls/cross_impl_agg_msg.bin` | `&[u8]` | 46 | Message bytes signed by three validators in the cross-impl aggregate test |
| `crypto/bls/cross_impl_agg_pubkey_1.bin` | `blst::min_pk::PublicKey (compressed)` | 48 | First validator pubkey in the cross-impl aggregate test |
| `crypto/bls/cross_impl_agg_pubkey_2.bin` | `blst::min_pk::PublicKey (compressed)` | 48 | Second validator pubkey in the cross-impl aggregate test |
| `crypto/bls/cross_impl_agg_pubkey_3.bin` | `blst::min_pk::PublicKey (compressed)` | 48 | Third validator pubkey in the cross-impl aggregate test |
| `crypto/bls/cross_impl_agg_signature.bin` | `blst::min_pk::Signature (compressed)` | 96 | Aggregate signature over agg_msg from three signers |
...
| `crypto/bls/cross_impl_msg_long.bin` | `&[u8]` | 256 | 256-byte message exercising expand_message_xmd b_i chain |
...
| `crypto/bls/cross_impl_signature_empty_msg.bin` | `blst::min_pk::Signature (compressed)` | 96 | Signature over the empty message — exercises hash-to-curve edge case |
| `crypto/bls/cross_impl_signature_long_msg.bin` | `blst::min_pk::Signature (compressed)` | 96 | Signature over the 256-byte message |
